...
class REQ:
   ...
   def UserAgent(self):
       ...
       # Generate UserAgent
       self.ua1 = f"Mozilla/5.0 (Linux; Android 10; RMX2195 Build/{self.build}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(self.rr(65, 99))}.0.{str(self.rr(3100, 3900))}.{str(self.rr(75, 99))} Mobile Safari/537.36,gzip(gfe)"
   ...
   def UserAgent_APP(self):
       ...
       self.app1 = f"Mozilla/5.0 (Linux; Android 10; Infinix NOTE 2 LTE Build/{self.build1}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(self.rr(55, 99))}.0.{str(self.rr(2500, 2999))}.{str(self.rr(75, 199))} Mobile Safari/537.36 [FB_IAB/MESSENGER;FBAV/{str(self.rr(75, 150))}.0.0.21.71;]"
   ...
   def Logooo(self):
       Console().print(Markdown(f"## HACKING MODE GACOR. @KalProZyy_"),style='bold blue')
       Console().print(f' {M2}Gas {K2}Keun {H2}Trus')
       Console().print(f'''    {O2}  
   ...
   def Menuuu(self):
       ...
       if ykhh =='1' or ykhh =='01':
         ...
         Furthermore().Methodee()
           ...
           try:
                 Console().print(Markdown(f"## Masukan nama target, example : asep, septian, siti"),style='thistle1')
